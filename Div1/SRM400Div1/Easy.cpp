...
private:
    ...
    void test_case_5() { string Arg0 = "94931877133"; int Arr1[] = {37, 7 }; vector <int> Arg1(Arr1, Arr1 + (sizeof(Arr1) / sizeof(Arr1[0]))); verify_case(5, Arg1, baseAndExponent(Arg0)); }
