...
public:
    ...
    int
    find(int redCount, int redHeight, int blueCount, int blueHeight)
    {
        int n;
...
private:
    ...
    void test_case_1() { int Arg0 = 5; int Arg1 = 4; int Arg2 = 4; int Arg3 = 7; int Arg4 = 13; verify_case(1, Arg4, find(Arg0, Arg1, Arg2, Arg3)); }
