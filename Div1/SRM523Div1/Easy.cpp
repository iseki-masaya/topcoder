...
public:
    ...
    long long countThem(long long a, long long b, long long c, long long d, long long upperBound) {
        long long ans = upperBound >= a ? 1 : 0;
        long long v = (upperBound - a) / b;
        ans += v>0 ? v : 0;
        if (d == 1) {
...
private:
    ...
    void test_case_4() { long long Arg0 = 2LL; long long Arg1 = 1LL; long long Arg2 = 2LL; long long Arg3 = 1LL; long long Arg4 = 1000000000000LL; long long Arg5 = 999999999999LL; verify_case(4, Arg5, countThem(Arg0, Arg1, Arg2, Arg3, Arg4)); }
    // END CUT HERE
