...
private:
    ...
    void test_case_6() { int Arg0 = 2198; int Arg1 = 0; int Arg2 = 2; string Arg3 = "DDUUUUUD"; string Arg4 = "YES"; verify_case(6, Arg4, possible(Arg0, Arg1, Arg2, Arg3)); }
